...
const elementPer = document.querySelector('#personal'); //select by id
console.log(elementPer.innerHTML);


const elementName = document.querySelector(".name");//select by class
console.log(elementName.innerHTML);
 

const elementH3Contact = document.querySelector("h3");// select by name
