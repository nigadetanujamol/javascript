...
/**************************************************************************/
//wAP to get even no using filter
...
/*******************************************************/
console.log("Get the list of tcs employee names using filter ");
...
const arrayIds =arraySalaries.map( (employee)=> { //to get id we use map
