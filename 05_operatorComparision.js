// = assignment operator
// == equal operator ------> check only value i.e string == string
//=== strictly equal  ------>check value with data type
//conversion done Automatically called implicit conversion.i.e string to number.
